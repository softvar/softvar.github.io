/* new-site-engine - v1.0.0 - 2016-06-30
...
(function($, undefined){
    ...
    Kudoable = (function() {
        ...
        Kudoable.prototype.start = function(){
        	savedCount = parseInt(this.$counter.html(), 10);
            if(!this.isKudoed()){
            	this.$counter.html('Don\'t');
	        	this.element.find('.count .txt').html('Move');
                this.element.addClass('active');

                this.activationTimer = setTimeout(this.complete, 1000);
            }
        };

        Kudoable.prototype.stop = function(){
			if (!this.isKudoed()) {
	        	this.$counter.html(savedCount);
	        	this.element.find('.count .txt').html('Kudos');
			}
        ...
        Kudoable.prototype.complete = function(){
            ...
            toast('Thanks, for liking the post!', 4000);
        };
        ...
        Kudoable.prototype.undo = function(){
            if(this.isKudoed()){
                ...
                toast('Any <a class="yellow-text" style="padding-left:4px;padding-right:4px;" href="#" onclick=\'$("html, body").animate({ scrollTop: $(document).height() }, 10);\'>Comments</a> or <a class="yellow-text" style="padding-left:4px;padding-right:4px;" href="/about" target="_blank">Feedback</a> for disliking ?', 8000);
            }
        };
